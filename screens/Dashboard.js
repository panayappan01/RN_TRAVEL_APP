...
const Dashboard = ({ navigation }) => {
    ...
    return (
      <Animated.FlatList
        ...
        renderItem={({ item, index }) => {
          //   console.log("COUNTRYSCROLLX ", countryScrollX);
          ...
          const mapSize = dotPosition.interpolate({
            inputRange: [index - 2, index - 1, index],
            outputRange: [25, Platform.OS === "ios" ? 80 : 60, 25],
            extrapolate: "clamp",
          });

          const fontSize = dotPosition.interpolate({
            inputRange: [index - 2, index - 1, index],
  ...
  function exploreButtonHandler() {
    ...
    console.log("INDEX ITEM ", places[currentIndex]);
      ...
      <Animated.FlatList
        ...
        renderItem={({ item, index }) => {
          ...
          if (Platform.OS === "ios") {
            ...
            // activeHeight = SIZES.height / 1.78;
          }
